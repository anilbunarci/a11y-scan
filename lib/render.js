    ...
    <table>
      <thead>
        <tr>
          ...
          <th style="min-width:95px">Issue Count</th>
          <th style="min-width:110px">A11y Findings</th>
          <th style="min-width:110px">Extended A11y</th>
    ...
    <table class="fixed">
      ...
      <thead>
        <tr>
          <th>URL</th>
          <th>Reports</th>
          <th class="sortable" data-col="2" title="Performance">Perf. <span class="sort-arrow"></span></th>
          <th class="sortable" data-col="3" title="Accessibility">A11y <span class="sort-arrow"></span></th>
          <th class="sortable" data-col="4" title="Best Practices">Best Pcs. <span class="sort-arrow"></span></th>
          <th class="sortable" data-col="5">SEO <span class="sort-arrow"></span></th>
          <th class="sortable" data-col="6">Issue Count <span class="sort-arrow"></span></th>
          <th class="sortable" data-col="7">A11y Findings <span class="sort-arrow"></span></th>
          <th class="sortable" data-col="8">Extended A11y <span class="sort-arrow"></span></th>
          <th>Top Issues</th>
          <th>Status</th>
        </tr>
      </thead>
...
<head>
  ...
  <style>
    ...
    table.fixed td:nth-child(1), table.fixed td:nth-child(10), table.fixed td:nth-child(12) { white-space: normal; word-break: break-word; overflow: visible; }
    ...
    .sort-arrow { display: inline-block; width: 0.8em; margin-left: 2px; font-size: 0.85em; opacity: 0.5; }
