...
<head>
  ...
  <style>
    ...
    table { width: 100%; border-collapse: collapse; margin: 24px 0px 40px; }
    table.fixed { table-layout: fixed; }
    table.fixed th, table.fixed td { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
    table.fixed td:nth-child(2) { white-space: normal; word-break: break-word; }
    table.paginated { margin: 24px 0px 16px; }
